    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans selection:bg-yellow-100 flex flex-col justify-between p-6 md:p-12">
      ...
      <main className="flex-1 flex flex-col items-center justify-center w-full max-w-6xl mx-auto mt-12 md:mt-0">
        ...
        <div className="text-center mb-16 relative">
          <span className="inline-block py-1 px-3 rounded-full bg-yellow-100 text-xs font-medium text-yellow-800 mb-6">
            Join the community
          </span>
        ...
        <div className="flex flex-col md:flex-row items-stretch justify-between w-full gap-12 md:gap-20">
          ...
          <div className="flex-1 w-full space-y-4 flex flex-col justify-center">
            ...
            >
              ...
              <span className="text-lg font-medium text-gray-700">Sign up with Gmail Account</span>
            </button>
            ...
            >
              ...
              <span className="text-lg font-medium text-gray-700">Sign up with GitHub account</span>
            </button>
        ...
        <div className="mt-16 text-center">
          <Link to="/contact" className="text-lg font-medium text-gray-900 hover:text-gray-600 transition-colors border-b-2 border-black/10 hover:border-black pb-0.5">
            Need Help?
          </Link>
        </div>
