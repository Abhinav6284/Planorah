...
export default function CompletenessCard({ completeness }) {
  ...
  return (
    <div className="bg-white dark:bg-charcoal border border-gray-200 dark:border-white/10 rounded-3xl p-5 shadow-sm">
      ...
      <div className="mb-3">
        <div className="h-2 rounded-full bg-gray-100 dark:bg-charcoal overflow-hidden">
