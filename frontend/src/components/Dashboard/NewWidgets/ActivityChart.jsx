...
const ActivityChart = ({ data }) => {
    ...
    return (
        <div className="bg-white dark:bg-charcoal rounded-[30px] p-6 h-full flex flex-col justify-between relative shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex justify-between items-end h-32 mt-4 px-2">
                {chartData.map((item, index) => (
                    <div key={index} className="flex flex-col items-center gap-3 group w-full">
                        <div className="relative w-2 bg-gray-100 dark:bg-charcoalMuted rounded-full h-full flex items-end overflow-visible">
                            ...
                            <div
                                ...
                                className={`w-full rounded-full transition-all duration-500 ${item.active ? 'bg-yellow-400 shadow-lg shadow-yellow-400/30' : 'bg-gray-800 dark:bg-charcoalMuted500 group-hover:bg-gray-600'}`}
                            ></div>
                        </div>
