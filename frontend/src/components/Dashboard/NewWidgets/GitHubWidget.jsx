...
const GitHubWidget = () => {
    ...
    if (status.loading) {
        return (
            <div className="bg-white dark:bg-charcoal rounded-[28px] p-5 h-full flex items-center justify-center">
    ...
    return (
        <div className="bg-white dark:bg-charcoal rounded-[28px] p-5 h-full flex flex-col relative overflow-hidden border border-gray-100 dark:border-charcoalMuted">
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                <span className={`text-xs px-2 py-1 rounded-full ${status.connected ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400' : 'bg-gray-100 dark:bg-charcoal text-gray-500'}`}>
                        ...
                        {repos.length > 0 ? (
                            repos.map((repo, index) => (
                                <a
                                    ...
                                    className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-charcoal/50 rounded-xl hover:bg-gray-100 dark:hover:bg-charcoalMuted transition-colors group"
                                >
                                    <div className="w-8 h-8 bg-gray-200 dark:bg-charcoalMuted rounded-lg flex items-center justify-center">
