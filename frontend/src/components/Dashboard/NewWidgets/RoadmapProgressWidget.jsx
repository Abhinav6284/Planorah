        ...
        return (
            <div className="bg-white dark:bg-[#111] rounded-[32px] p-6 h-full shadow-sm">
                <div className="animate-pulse">
                    <div className="h-6 bg-gray-200 dark:bg-charcoalMuted rounded w-1/3 mb-4"></div>
                    <div className="space-y-3">
                        <div className="h-16 bg-gray-200 dark:bg-charcoalMuted rounded-xl"></div>
                        <div className="h-16 bg-gray-200 dark:bg-charcoalMuted rounded-xl"></div>
                    </div>
                </div>
            </div>
                ...
                <div className="space-y-3">
                    {roadmaps.map((roadmap, index) => (
                        <motion.div
                            ...
                            className="p-3 bg-gray-50 dark:bg-charcoal/50 rounded-xl cursor-pointer hover:bg-gray-100 dark:hover:bg-charcoalMuted transition-colors"
                        >
