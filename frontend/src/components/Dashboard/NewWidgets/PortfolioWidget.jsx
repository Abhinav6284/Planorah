...
const PortfolioWidget = () => {
    ...
    const getStatusBadge = () => {
        if (!portfolio) return { bg: 'bg-gray-100 dark:bg-charcoal', text: 'text-gray-500', label: 'Not Set' };
        const statuses = {
            ...
            read_only: { bg: 'bg-blue-100 dark:bg-charcoal/30', text: 'text-blue-600 dark:text-blue-400', label: 'Free Plan' },
        ...
        <div className="bg-white dark:bg-charcoal rounded-[28px] p-5 h-full flex flex-col relative overflow-hidden border border-gray-100 dark:border-charcoalMuted">
            ...
            {portfolio ? (
                <div className="flex-1 flex flex-col">
                    {/* Info Card */}
                    <div className="bg-gray-50 dark:bg-charcoal/50 rounded-2xl p-4 mb-4 flex-1">
                        <div className="flex items-start gap-3 mb-3">
                            <div className="w-12 h-12 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-charcoalMuted dark:to-charcoalMuted rounded-xl overflow-hidden flex-shrink-0">
                        ...
                        {/* URL */}
                        <div className="flex items-center gap-2 p-2 bg-white dark:bg-charcoalDark rounded-lg">
                    ...
                    <div className="flex gap-2">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="px-4 py-2 bg-gray-100 dark:bg-charcoal text-gray-700 dark:text-gray-300 rounded-xl text-sm font-medium hover:bg-gray-200 dark:hover:bg-charcoalMuted transition-colors"
                        >
                            View →
                        </a>
                    </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center">
                    <div className="w-16 h-16 bg-gray-100 dark:bg-charcoal rounded-2xl flex items-center justify-center mb-4">
