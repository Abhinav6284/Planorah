        ...
        <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#1a1a1a] p-6 shadow-soft dark:shadow-none">
            <div className="flex items-center gap-2 mb-5">
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-bold text-gray-950 dark:text-white uppercase tracking-wide">Activity Feed</h3>
                </div>
            </div>

            <div className="space-y-3">
                {feed.map((item) => (
                    <div key={item.id} className="flex items-start gap-3 pb-3 border-b border-borderMuted dark:border-white/10 last:border-0">
                        <div className={`mt-0.5 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg ${
                            ...
                            'bg-borderMuted/50 dark:bg-white/10 text-gray-600 dark:text-gray-400'
                        }`}>
