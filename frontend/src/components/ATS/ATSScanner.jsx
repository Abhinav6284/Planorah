            ...
            <div className="p-8">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 pb-20">
                    ...
                    <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="xl:col-span-4 space-y-6">
                        <div className="bg-white dark:bg-[#1a1a1a] p-6 rounded-2xl border-0 shadow-[0_8px_16px_rgba(0,0,0,0.06)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.1)] transition-all duration-300">
                        ...
                        <AnimatePresence>
                            {result ? (
                                <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="space-y-6">
                                    ...
                                    <div className="bg-white dark:bg-[#1a1a1a] rounded-3xl p-6 border-0 shadow-[0_8px_16px_rgba(0,0,0,0.06)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.1)] transition-all duration-300 flex flex-col md:flex-row items-center gap-8">
                                    ...
                                    {/* Summary Card */}
                                    <div className="bg-white dark:bg-[#1a1a1a] p-6 rounded-3xl border-0 shadow-[0_8px_16px_rgba(0,0,0,0.06)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.1)] transition-all duration-300">
