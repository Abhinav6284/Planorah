...
export default function ATSScanner() {
    ...
    const handleScan = async () => {
        ...
        try {
            const token = localStorage.getItem("access_token");
            const response = await axios.post(`/ats/analyze/`, formData, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    return (
        <div className="min-h-full bg-gray-50 dark:bg-charcoalDark transition-colors duration-200 font-sans">
            <div className="p-8">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 pb-20">
                    ...
                    <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="xl:col-span-4 space-y-6">
                        <div className="bg-white dark:bg-charcoal p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-charcoalMuted">
                            ...
                            <div className="mb-6">
                                ...
                                <input
                                    type="text"
                                    className="w-full px-4 py-3 bg-gray-50 dark:bg-charcoalMuted border border-gray-200 dark:border-charcoalMuted rounded-xl focus:ring-2 focus:ring-black dark:focus:ring-white outline-none text-gray-900 dark:text-white"
                            ...
                            <div className="mb-6">
                                ...
                                <textarea
                                    className="w-full h-32 px-4 py-3 bg-gray-50 dark:bg-charcoalMuted border border-gray-200 dark:border-charcoalMuted rounded-xl focus:ring-2 focus:ring-black dark:focus:ring-white outline-none text-gray-900 dark:text-white resize-none"
                            ...
                            {/* Resume Input Toggle */}
                            <div className="mb-6">
                                <div className="flex gap-4 mb-4 border-b border-gray-100 dark:border-charcoalMuted pb-2">
                                    <button
                                ...
                                {inputMode === 'select' ? (
                                    <div>
                                        {myResumes.length > 0 ? (
                                            <select
                                                ...
                                                className="w-full px-4 py-3 bg-gray-50 dark:bg-charcoalMuted border border-gray-200 dark:border-charcoalMuted rounded-xl focus:ring-2 focus:ring-black dark:focus:ring-white outline-none text-gray-900 dark:text-white appearance-none"
                                            >
                                    ...
                                    <textarea
                                        className="w-full h-40 px-4 py-3 bg-gray-50 dark:bg-charcoalMuted border border-gray-200 dark:border-charcoalMuted rounded-xl focus:ring-2 focus:ring-black dark:focus:ring-white outline-none text-gray-900 dark:text-white resize-none"
                        ...
                        <AnimatePresence>
                            {result ? (
                                <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="space-y-6">
                                    ...
                                    <div className="bg-white dark:bg-charcoal rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-charcoalMuted flex flex-col md:flex-row items-center gap-8">
                                        ...
                                        <div className="flex-1 w-full grid grid-cols-2 lg:grid-cols-4 gap-4">
                                            <div className="bg-gray-50 dark:bg-charcoalMuted/50 p-4 rounded-2xl text-center">
                                            ...
                                            <div className="bg-gray-50 dark:bg-charcoalMuted/50 p-4 rounded-2xl flex flex-col items-center justify-center cursor-pointer hover:bg-gray-100 dark:hover:bg-charcoalMuted transition-colors">
                                    ...
                                    {/* Summary Card */}
                                    <div className="bg-white dark:bg-charcoal p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-charcoalMuted">
                                    ...
                                    <div className="bg-white dark:bg-charcoal p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-charcoalMuted">
                                        <div className="flex items-center gap-2 mb-4">
                                            <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-charcoal/30 flex items-center justify-center text-blue-600 text-sm">💡</div>
                                            <h3 className="font-bold text-gray-900 dark:text-white">Actionable Improvements</h3>
                                        </div>
                                        <ul className="space-y-3">
                                            {result.improvement_areas.map((item, i) => (
                                                <li key={i} className="flex items-start gap-3 p-3 rounded-xl bg-blue-50/50 dark:bg-charcoal/5">
                                ...
                                <div className="h-full flex flex-col items-center justify-center text-gray-400 border-2 border-dashed border-gray-200 dark:border-charcoalMuted rounded-3xl min-h-[500px] bg-white/50 dark:bg-charcoal/50">
                                    <div className="w-20 h-20 bg-gray-100 dark:bg-charcoalMuted rounded-full flex items-center justify-center mb-6 text-4xl">
                                        📄
                                    </div>
