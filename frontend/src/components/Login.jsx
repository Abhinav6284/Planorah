      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500">Good to see you again, let's grind together</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-gray-900 text-white rounded-full font-semibold hover:bg-gray-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
