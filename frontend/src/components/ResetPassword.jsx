...
import { Eye, EyeOff, CheckCircle2, AlertCircle, ArrowRight, Sun, Moon } from "lucide-react";
...
export default function ResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage("success:" + (res.data.message || "Password reset successfully."));
        ...
        <div className="relative z-10 flex flex-col h-full p-12">
          ...
          <div className="flex-1 flex flex-col justify-center relative">
            <div className="relative z-10 px-4">
              ...
              >
                Choose a strong password you can remember. Make it unique and secure.
              </motion.p>
            </div>
          </div>
          ...
          >
            {[["8+ chars", "Minimum"], ["Special", "Optional"], ["Unique", "Required"]].map(([val, label]) => (
              <div key={label}>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2 pt-1">
                <div className={`flex items-center gap-2 text-[12px] ${passwordStrength ? "text-green-600 dark:text-green-400" : "text-gray-500 dark:text-gray-400"}`}>
                  <div className={`w-1.5 h-1.5 rounded-full ${passwordStrength ? "bg-green-600 dark:bg-green-400" : "bg-gray-300 dark:bg-gray-600"}`} />
                  At least 8 characters
                </div>
                <div className={`flex items-center gap-2 text-[12px] ${passwordsMatch ? "text-green-600 dark:text-green-400" : "text-gray-500 dark:text-gray-400"}`}>
                  <div className={`w-1.5 h-1.5 rounded-full ${passwordsMatch ? "bg-green-600 dark:bg-green-400" : "bg-gray-300 dark:bg-gray-600"}`} />
                  Passwords match
                </div>
              </div>
