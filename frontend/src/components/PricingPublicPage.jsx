      ...
      tiers: [
        {
          ...
          description: 'Everything you need to get started with AI planning',
          features: [
        ...
        },
        {
          ...
          price: '19.99',
          priceNote: '/month',
          description: 'For the obsessed—teams, portfolios, coaching',
          features: [
            'Everything in Pro',
            'Team collaboration (Inner Circle)',
            'Exam prep module',
            'Behavior insights (Mirror)',
            'Live portfolio hosting',
            'API access',
