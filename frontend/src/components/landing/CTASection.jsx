    ...
    <section className="py-28 md:py-36 px-4 md:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-white/80 text-sm font-medium mb-8"
        >
        ...
        >
          <Link to="/register">
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="group px-10 py-4 bg-white text-gray-900 rounded-2xl text-base font-bold shadow-xl flex items-center gap-2 hover:bg-gray-100 transition-colors"
            >
              Get Started Free
