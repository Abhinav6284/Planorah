        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <motion.div
              ...
              className={`group relative bg-white dark:bg-gray-800/60 rounded-2xl border border-gray-100 dark:border-gray-700/50 p-6 hover:shadow-xl hover:shadow-gray-100/80 dark:hover:shadow-gray-900/80 transition-shadow duration-300 overflow-hidden`}
            >
              {/* Subtle gradient hover overlay */}
              <div className={`absolute inset-0 bg-gray-500 opacity-0 group-hover:opacity-[0.03] dark:group-hover:opacity-[0.06] transition-opacity duration-300 rounded-2xl`} />

              {/* Icon */}
              <div className={`relative w-12 h-12 rounded-xl bg-gray-50 dark:bg-gray-800/80 flex items-center justify-center mb-5`}>
              ...
              {/* Badge */}
              <span className="inline-block px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 mb-3">
                {feature.badge}
              </span>
