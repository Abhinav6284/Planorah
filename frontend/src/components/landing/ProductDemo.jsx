    ...
    <div className="w-full h-full rounded-3xl bg-white dark:bg-charcoalDark/90 backdrop-blur-sm shadow-soft dark:shadow-darkSoft p-10 flex flex-col justify-center relative overflow-hidden font-outfit transition-colors duration-500">
      <div className="space-y-8 relative z-10 w-[90%] mx-auto">
        <div className="flex items-center gap-4 mb-4">
          <div className="w-14 h-14 bg-[#EBE6DA] dark:bg-charcoal rounded-2xl flex items-center justify-center border border-white dark:border-white/[0.08] shadow-sm text-[#D96C4A]">
        ...
        <div className="space-y-3">
          ...
          <div className="h-14 w-full bg-beigeSecondary dark:bg-charcoalDark border border-beigeMuted dark:border-white/[0.08] rounded-2xl flex items-center px-5 text-[15px] text-gray-950 dark:text-white font-medium shadow-sm">
          ...
          <div className="flex gap-3">
            {["3 months", "6 months", "1 year"].map((t, i) => (
              <div key={t} className={`flex-1 py-3 rounded-xl text-center text-[13px] font-bold border transition-colors ${i === 1
                ...
                : "bg-transparent text-gray-500 dark:text-gray-400 border-beigeMuted dark:border-white/[0.08]"
                }`}>
                {t}
              </div>
            ))}
        ...
        <button className="w-full h-14 bg-[#EBE6DA] dark:bg-charcoal text-gray-950 dark:text-white rounded-xl flex items-center justify-center gap-3 text-[14px] font-bold shadow-sm border border-beigeMuted dark:border-white/[0.08] mt-4">
  ...
  <div className="p-[1px] rounded-3xl bg-gradient-to-br from-purple-400/70 via-pink-400/50 to-red-400/40">
    <div className="w-full h-full rounded-3xl bg-white dark:bg-charcoalDark/90 backdrop-blur-sm shadow-soft dark:shadow-darkSoft p-10 flex flex-col justify-center relative overflow-hidden font-outfit transition-colors duration-500">
      <div className="space-y-6 relative z-10 w-[94%] mx-auto">
        <div className="flex items-center justify-between border-b border-beigeMuted dark:border-white/[0.08] pb-4">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-[#EBE6DA] dark:bg-charcoal border border-beigeMuted dark:border-white/[0.08] rounded-2xl flex items-center justify-center">
        ...
        <div className="space-y-3 pt-4">
          {[
            ...
            { m: "M3", title: "Airflow Pipelines", weeks: "Week 9-14", color: "bg-[#EBE6DA] dark:bg-charcoal" },
            { m: "M4", title: "Distributed Data", weeks: "Week 15-20", color: "bg-[#EBE6DA] dark:bg-charcoal" },
          ].map((item, i) => (
            <div key={i} className="bg-beigeSecondary dark:bg-charcoalDark rounded-xl border border-beigeMuted dark:border-white/[0.08] p-3.5 flex gap-4 items-center transition-colors">
...
const TasksMockup = () => (
  <div className="p-[1px] rounded-3xl bg-gradient-to-br from-emerald-400/70 via-teal-400/50 to-cyan-400/40">
    <div className="w-full h-full rounded-3xl bg-white dark:bg-charcoalDark/90 backdrop-blur-sm shadow-soft dark:shadow-darkSoft p-10 flex flex-col justify-center relative overflow-hidden font-outfit transition-colors duration-500">
      <div className="space-y-6 relative z-10 w-[94%] mx-auto">
        <div className="flex items-center justify-between pb-4 border-b border-beigeMuted dark:border-white/[0.08] text-gray-950 dark:text-white">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-[#EBE6DA] dark:bg-charcoal border border-beigeMuted dark:border-white/[0.08] rounded-2xl flex items-center justify-center">
  ...
  <div className="p-[1px] rounded-3xl bg-gradient-to-br from-amber-400/70 via-orange-400/50 to-red-400/40">
    <div className="w-full h-full rounded-3xl bg-white dark:bg-charcoalDark/90 backdrop-blur-sm shadow-soft dark:shadow-darkSoft p-10 flex flex-col justify-center relative overflow-hidden font-outfit transition-colors duration-500">
      <div className="space-y-8 relative z-10 w-[94%] mx-auto">
        <div className="flex items-center gap-4 border-b border-beigeMuted dark:border-white/[0.08] pb-6 text-gray-950 dark:text-white">
          <div className="w-14 h-14 bg-[#EBE6DA] dark:bg-charcoal border border-beigeMuted dark:border-white/[0.08] rounded-2xl flex items-center justify-center">
        ...
        <div className="flex items-center gap-10">
          ...
          <div className="space-y-5 flex-1 w-full">
            {[
              ...
              <div key={i} className="p-3 rounded-xl bg-beigeSecondary dark:bg-charcoalDark border border-beigeMuted dark:border-white/[0.08] text-gray-950 dark:text-white transition-colors">
  ...
  <div className="p-[1px] rounded-3xl bg-gradient-to-br from-violet-400/70 via-purple-400/50 to-indigo-400/40">
    <div className="w-full h-full rounded-3xl bg-white dark:bg-charcoalDark/90 backdrop-blur-sm shadow-soft dark:shadow-darkSoft p-10 flex flex-col items-center justify-center relative overflow-hidden text-center font-outfit transition-colors duration-500">
      <div className="relative z-10 space-y-8 w-full max-w-sm">
        <div className="w-28 h-28 bg-[#EBE6DA] dark:bg-charcoal border border-beigeMuted dark:border-white/[0.08] rounded-[2.5rem] flex items-center justify-center mx-auto shadow-sm text-[#D96C4A]">
...
export default function ProductDemo() {
  ...
  return (
    <section
      id="how-it-works"
      className="py-32 bg-beigeSecondary dark:bg-charcoal transition-colors duration-500"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-24">
          ...
          >
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#EBE6DA] dark:bg-white/[0.06] border border-beigeMuted dark:border-white/[0.08] text-xs font-semibold text-[#D96C4A] uppercase tracking-widest">How It Works</span>
          </motion.div>
          <motion.h2
            ...
            {steps.map((step, idx) => (
              <button
                ...
                className={`w-full text-left p-5 lg:p-6 rounded-[1.5rem] border transition-all duration-500 group relative overflow-hidden ${
                  activeTab === idx
                    ? "bg-beigeSecondary dark:bg-charcoalDark border-beigeMuted dark:border-white/[0.08] shadow-soft dark:shadow-darkSoft opacity-100"
              ...
              >
                {activeTab === idx && !isPaused && (
                  <motion.div
                    ...
                    className="absolute bottom-0 left-0 h-1 bg-[#E5DFCC] dark:bg-white/10"
                  />
                )}

                <div className="flex items-start gap-5 relative z-10">
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-colors duration-500 ${
                    activeTab === idx ? "bg-[#D96C4A] text-white" : "bg-[#EBE6DA] dark:bg-charcoal text-gray-950 dark:text-white"
                  }`}>
