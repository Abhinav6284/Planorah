          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link to="/register">
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="px-5 py-2.5 bg-gradient-to-r from-violet-600 to-indigo-600 text-white rounded-xl text-sm font-semibold shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 transition-shadow"
              >
                Get Started Free
              </motion.button>
            </Link>
            ...
            >
              ...
              <div className="p-6 border-t border-gray-100 dark:border-gray-800 space-y-3">
                ...
                <Link to="/register" onClick={() => setMobileMenuOpen(false)}>
                  <button className="w-full py-3 bg-gradient-to-r from-violet-600 to-indigo-600 text-white rounded-xl font-semibold">
                    Get Started Free
                  </button>
                </Link>
              </div>
