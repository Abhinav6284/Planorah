            ...
            >
              ...
              <div className="p-6 border-t border-gray-100 dark:border-gray-800 space-y-3">
                ...
                <Link to="/register" onClick={() => setMobileMenuOpen(false)}>
                  <button className="w-full py-3 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-xl font-semibold hover:bg-gray-700 dark:hover:bg-gray-100 transition-colors">
                    Get Started Free
                  </button>
                </Link>
              </div>
