...
export default function Footer() {
  return (
    <footer className="bg-gray-900 dark:bg-black text-gray-400 py-20 px-4 md:px-8 relative overflow-hidden">
      {/* Subtle background */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] [background-size:48px_48px]" />
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-16">
          ...
          <div className="col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4 group">
              <div className="w-8 h-8 rounded-lg bg-violet-600 flex items-center justify-center shadow-md shadow-violet-500/25">
            ...
            <p className="text-sm leading-relaxed mb-6 max-w-xs">
              The proof-based platform for builders, learners, and creators who want to turn goals into verified work.
            </p>
            {/* Social icons */}
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-8 border-t border-gray-800">
          <p className="text-sm text-gray-600">
            © 2025 Planorah. All rights reserved.
          </p>
          <p className="text-sm text-gray-600">
            Built with{" "}
